...
import { ENTITY_KINDS, kindRows, findRow } from "@/data/contracts";
import type {
  AchievementRow,
  EndingRow,
  MinigameRow,
...
// display-name layer split into a JSX-free module (entityDisplay.ts) so the
// node --test lane can import mapView's builders; re-exported below for API
// stability alongside personageById.
...
/** Display-name layer lives in entityDisplay.ts — re-exported here. */
export { displayName, desluggedLabel, personageById } from "./entityDisplay";
import { displayName, desluggedLabel, personageById } from "./entityDisplay";
